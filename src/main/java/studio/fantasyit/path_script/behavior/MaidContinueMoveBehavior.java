...
public class MaidContinueMoveBehavior extends Behavior<EntityMaid> {

    public MaidContinueMoveBehavior() {
        super(Map.of(
    ...
    protected void start(ServerLevel level, EntityMaid maid, long timestamp) {
        ...
        BehaviorUtils.setWalkAndLookTargetMemories(maid, cur.get(), 0.5f, 1);
    }
}
